...
import * as headerStyles from "./app-header.module.css"

export default function AppHeader({ onDemoToggle, onTrialToggle }) {
  ...
  // let mobileDevice = /Android|webOS|iPhone|iPad|iPod|tablet|BlackBerry|IEMobile|Opera Mini/i.test(
  //   navigator.userAgent
  // )
  ...
  return (
    <header
      // style={window.location.pathname !== "/" ? style : null}
      className={headerStyles.appHeader}
    >
      <h1>
        <Link to="/">
          <svg
      ...
      >
        <button onClick={onToggleClass} className={headerStyles.close}>
          <IoMdClose />
          close navigation
        </button>
        ...
        <ul>
          ...
          <li>
            <Link onClick={onToggleClass} to="/about">
              About Us
            </Link>
          </li>
          <li className={headerStyles.service}>
            <a onClick={onToggleClass} href="/#services">
              Services
            </a>
            <ul>
              <li>
                <Link to="/headcount">Headcount Management</Link>
              </li>
              <li>
                <Link to="/recruiting">Recruiting & Hiring</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/attendance">Time and Attendance</Link>
              </li>
              <li>
      ...
      <button className={headerStyles.menu} onClick={onToggleClass}>
        <IoMdMenu />
        navigation
      </button>
    </header>
